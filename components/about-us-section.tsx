...
export function AboutUsSection() {
  ...
  return (
    <section 
      ref={sectionRef}
      className={`py-8 sm:py-12 lg:py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 to-emerald-50/30 ${getFontClass()}`}
    >
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}>
            ...
            <div className={`grid grid-cols-2 gap-3 sm:gap-4 lg:gap-6 mb-6 sm:mb-8 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <Button 
              size="lg" 
              className={`bg-emerald-600 rounded-3xl hover:bg-emerald-700 transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            >
              {t("aboutUs.learnMore")}
            </Button>
          </div>

          <div className={`relative w-full max-w-full transition-all duration-1000 delay-700 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}>
            ...
            <div className={`absolute -bottom-4 sm:-bottom-6 -left-4 sm:-left-6 bg-emerald-600 text-white p-3 sm:p-4 rounded-lg shadow-lg transition-all duration-1000 delay-900 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
