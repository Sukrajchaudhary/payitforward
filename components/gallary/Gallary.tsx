...
const Gallery = () => {
  ...
  const data = useMemo(() => [
    { 
      id: "1", 
      imageurl: "https://res.cloudinary.com/dfzg6gkoh/image/upload/v1757174157/odftsa6onlo0ulpmkb3u.jpg",
      alt: "Volunteer community service activity",
      title: "Community Service"
    },
    { 
      id: "2", 
      imageurl: "https://res.cloudinary.com/dfzg6gkoh/image/upload/v1757174157/ni65bolu2kqrqc2lkpcv.jpg",
    ...
    { 
      id: "4", 
      imageurl: "https://res.cloudinary.com/dfzg6gkoh/image/upload/v1757174157/kdutrtjbms87sfhlvuxk.jpg",
      alt: "Environmental volunteering",
      title: "Environmental Care"
    },
    { 
      id: "5", 
      imageurl: "https://res.cloudinary.com/dfzg6gkoh/image/upload/v1757174156/udriuphi1pwb1dtpziy4.jpg",
      alt: "Healthcare volunteer work",
      title: "Healthcare Support"
    },
    { 
      id: "6", 
      imageurl: "https://res.cloudinary.com/dfzg6gkoh/image/upload/v1757174156/egrpkzghk8cibykjlrlq.jpg",
      alt: "Community development project",
      title: "Community Development"
    },
    { 
      id: "7", 
      imageurl: "https://res.cloudinary.com/dfzg6gkoh/image/upload/v1757174156/mflcaacdxpkjma1jvphp.jpg",
      alt: "Volunteer team collaboration",
      title: "Team Collaboration"
    },
    { 
      id: "8", 
      imageurl: "https://res.cloudinary.com/dfzg6gkoh/image/upload/v1731929302/urmdshmrq4dzmbddbgzf.png",
      alt: "Social impact initiative",
      title: "Social Impact"
    },
    { 
      id: "9", 
      imageurl: "https://res.cloudinary.com/dfzg6gkoh/image/upload/v1757174679/mxhyug2gvglwmjmjjjt0.jpg",
      alt: "Volunteer training session",
      title: "Volunteer Training"
    },
    { 
      id: "10", 
      imageurl: "https://res.cloudinary.com/dfzg6gkoh/image/upload/v1757174735/rgxvmmdlui0yn8emyiqk.jpg",
      alt: "Community outreach program",
      title: "Community Outreach"
    },
    { 
      id: "11", 
      imageurl: "https://res.cloudinary.com/dfzg6gkoh/image/upload/v1757174766/kssnbr2mljbbs5sj3bbx.jpg",
      alt: "Volunteer appreciation event",
      title: "Volunteer Appreciation"
    },
    { 
      id: "12", 
      imageurl: "https://res.cloudinary.com/dfzg6gkoh/image/upload/v1757174734/xrdekh1u8u1kzbkjfmo4.jpg",
      alt: "Youth development program",
      title: "Youth Development"
    },
    { 
      id: "13", 
      imageurl: "https://res.cloudinary.com/dfzg6gkoh/image/upload/v1757174736/if4vok1pief4hjumbkms.jpg",
  ...
  const getOptimizedImageUrl = useCallback((url: string, width: number = 400, quality: string = 'auto') => {
  ...
  return (
    <div className={`mx-auto px-2 md:px-0 py-12 ${getFontClass()}`}>
      <div className="flex flex-col gap-y-3 py-4 justify-between items-start">
        <p className="text-base font-semibold text-[#248406] uppercase tracking-wide">
          {t("gallery.sectionTitle") || "PHOTO GALLERY"}
        </p>
        <h1 className="text-4xl font-semibold">
          {t("gallery.title") || "Capturing Stories Through"} 
          <span className="text-[#248406]"> {t("gallery.titleHighlight") || "Photos"}</span>
        </h1>
        <p className="text-gray-600 text-lg max-w-2xl">
          {t("gallery.description") || "Explore our journey through impactful moments and community connections."}
        </p>
      </div>
            ...
            <div className="w-full h-full flex items-center justify-center">
              {selectedImage && data[currentIndex] && (
                <Image
                  ...
                  alt={data[currentIndex].alt || `Gallery Image ${currentIndex + 1} - Full View`}
                  width={1200}
                  height={800}
      ...
      <div className="mt-12 text-center">
        <div className="inline-flex items-center gap-8 bg-gradient-to-r from-emerald-50 to-blue-50 px-8 py-4 rounded-full">
          <div className="text-center">
            <div className="text-2xl font-bold text-[#248406]">{data.length}</div>
            <div className="text-sm text-gray-600">Photos</div>
          </div>
          <div className="w-px h-8 bg-gray-300"></div>
          <div className="text-center">
            <div className="text-2xl font-bold text-[#248406]">13</div>
            <div className="text-sm text-gray-600">Programs</div>
          </div>
          <div className="w-px h-8 bg-gray-300"></div>
          <div className="text-center">
            <div className="text-2xl font-bold text-[#248406]">2</div>
