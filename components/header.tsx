      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 sm:h-18 lg:h-20 items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-2 sm:gap-3 hover:opacity-80 transition-opacity">
            <div className="relative h-12 w-12 sm:h-14 sm:w-14 lg:h-16 lg:w-16 flex items-center justify-center rounded-full overflow-hidden ring-2 ring-green-100 shadow-sm">
              <Image 
          ...
          <nav className="hidden lg:flex items-center gap-8">
            {navItems.map((item) => (
              <Link
                ...
                href={item.href}
                className={cn(
                  "text-sm lg:text-base font-semibold transition-all duration-200 relative px-3 py-2",
                  isActive(item)
                    ? "text-green-600"
