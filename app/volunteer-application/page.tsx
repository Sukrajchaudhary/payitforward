...
import { Heart, Users, Globe, Sparkles, CheckCircle, Star, ArrowLeft } from "lucide-react"
...
export default function VolunteerApplicationPage() {
  ...
  return (
    <div
      className={`min-h-screen py-20 px-4 bg-gradient-to-br from-emerald-50 via-white to-blue-50 relative overflow-hidden ${getFontClass()}`}
    >
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl font-bold text-gray-900 mb-6 bg-gradient-to-r from-emerald-600 via-blue-600 to-purple-600 bg-clip-text text-transparent">
            {t("joinForm.title")}
          </h1>
